...
class DistrictsControllerTest < ActionController::TestCase
  ...
  test "should create district" do
    assert_difference('District.count') do
      post :create, district: { country: @district.country, district: @district.district, latitude: @district.latitude, longitude: @district.longitude, region: @district.region, shapefile: @district.shapefile, source_id: @district.source_id }
    end
  ...
  test "should update district" do
    patch :update, id: @district, district: { country: @district.country, district: @district.district, latitude: @district.latitude, longitude: @district.longitude, region: @district.region, shapefile: @district.shapefile, source_id: @district.source_id }
    assert_redirected_to district_path(assigns(:district))
  end
